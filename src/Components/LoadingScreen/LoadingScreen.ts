...
export const LoadingScreen = new CContainer('loading-screen',
  `
    ...
    <p class="loading-screen__continue-button">Нажмите, чтобы<img src='${require('../../Media/Images/UI/transparent_placeholder.png')}' class="loading-screen__tapImage loading-screen__tapImage_start"/> продолжить</p>
