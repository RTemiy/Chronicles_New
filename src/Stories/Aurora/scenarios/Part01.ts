...
scenarioManager.addScenario({ storyName: EStoriesEn.Aurora, chapterName: 'Глава 1', partName: 'Часть 1', code: '0' }, [
...

  {
    ...
    text:
      `
        В отражении зеркала мне показалась немного растерянного вида девушка, которая абсолютно не представляла свою дальнейшую жизнь. Но которая четко осознавала — сейчас происходит абсолютно непредсказуемый поворот в ее судьбе. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageBorder: require('../../../Images/Aurora/UI/Border.png'),
    achievement: { story: EStoriesEn.Aurora, name: 'Part01Completed' },
    imageBack: require('../../../Images/Aurora/Backgrounds/Lighthouse.jpg')
  }
])
