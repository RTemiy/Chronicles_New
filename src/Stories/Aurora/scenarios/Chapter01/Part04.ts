...
scenarioManager.addScenario({ storyName: EStoriesEn.Aurora, chapterName: 'Глава 1', partName: 'Часть 4', code: '0' }, [
...

  {
    ...
    text:
      `
        Меня зовут Аврора. Всю свою жизнь я жила в маленьком шведском городке вместе со своей семьей. Здесь не было каких-то тайн, каких-то скрытых смыслов. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Меня обуял страх, беспокойство. Я попыталась крикнуть, но мой голос отказывался мне подчиняться, а горло стало неистово жечь, будто бы наполняясь раскаленной лавой.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        В письме мне непременно стоит поделиться своим беспокойством с отцом. Он знает меня лучше всех и может подсказать, куда двигаться дальше. Мне бы не помешал его мудрый совет.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Может быть. Но мне видится, что все должно быть проще. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Так далеко от дома… Должно быть он очень скучает. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        И я ценила эти моменты, ведь мне казалось, что в этом огромном городе, я обрела еще больше поддержки. Друга, который мог меня понять и ценить. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    beforeBegin: () => {
      timer.set(5, () => { scenarioManager.beginScene(237) })
    },
    imageBack: require('../../../../Images/Aurora/Backgrounds/Auditory.jpg')
  },
...

  {
    ...
    text:
      `
        Далия и Калеб все еще оставались внутри, но я не захотела их дожидаться, мне не терпелось вернуться домой и проверить заветный почтовый ящик, который я проверяла каждый день. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Это терзало меня. Буквально выжигало изнутри. Тревога росла с каждым часом, а бессилие лишь усугубляло мое состояние. Что я могла сделать будучи такой слабой?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Артур, не долго думая, заключил меня в свои объятия и начал успокаивать, шепча мне на ухо о том, что все будет хорошо. 
      `,
    buttons: [
      {
        text: '',
