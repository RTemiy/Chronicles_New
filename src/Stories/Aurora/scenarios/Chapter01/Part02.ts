...
scenarioManager.addScenario({ storyName: EStoriesEn.Aurora, chapterName: 'Глава 1', partName: 'Часть 2', code: '0' }, [
...

  {
    ...
    text:
      `
        Чувства смешались. А как могло быть иначе, ведь меня будто вырывают из уютного кокона и оставляют одну на потеху неизвестности.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Наконец, и я решила подойти. Успев попрощаться с домом, теперь предстояло самое трудное.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Aurora_Painting.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bench.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Paper.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bench.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Disc.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bench.jpg')
  },
...

  {
    ...
    text:
      `
        — Да, — я смахнула непослушные слезы. — Думаю, пора выезжать.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Suburbs.jpg')
  },
...

  {
    ...
    text:
      `
        — Аврора, — не отвлекаясь от дороги, проговорил парень. — Понимаю, твои опасения. Но не переживай, у меня нет скрытых мотивов, я делаю это просто, чтобы помочь тебе встать на ноги.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Просто потому, что ты хороший человек, и вижу, как твой отец хотел другой жизни для своей дочери. Как ты желала чего-то нового. Помнишь наш разговор во время прогулки по лесу?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    music: require('../../../../Media/Audio/Aurora/Romantic_Man.mp3'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Forest.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Persons/Aurora_TShirt.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Forest.jpg')
  },
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Flower_Glade.jpg')
  },
...

  {
    ...
    text:
      `
        — Все хорошо, — я понимала, почему он задает такой вопрос и не врала. Но внешне это было трудно заметить. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    cutScene: { video: require('../../../../Media/Images/Aurora/Cutscenes/Flowerfield.mp4'), goTo: 141 },
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Flower_Glade.jpg')
  },
...

  {
    ...
    text:
      `
        Парень припарковался перед высотным зданием. Большой город встретил присущей ему суматохой. Много людей, спешивших по своим делам, много машин, много разных звуков. 
      `,
    buttons: [
      {
        text: '',
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Arthur_Home.jpg')
  },

  {
    ...
    text:
      `
        Выйдя из автомобиля, мы зашли в подъезд и поднялись в квартиру.  
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Я в порядке. Хочу как можно быстрее влиться в новый ритм жизни. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Разве можно подать дистанционно документы даже без согласия поступающего?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Я сильно вымоталась за этот насыщенный день, поэтому стоило голове коснуться подушки, как тут же уснула.
      `,
    buttons: [
      {
        text: 'Продолжить',
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Library.jpg')
  },
...

  {
    ...
    text:
      `
        Милая библиотекарша отвела меня в небольшой закуток, где находились необходимые источники. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Я стала осматривать полки в поисках исторических книг. Когда потянулась за нужной, чья-то мужская рука соприкоснулось с моей. Почувствовала легкую дрожь, пальцы незнакомца были необычайно холодными.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Развернувшись, чтобы увидеть наглеца, который утащил мою книгу, замерла.
      `,
    buttons: [
      {
        text: '',
