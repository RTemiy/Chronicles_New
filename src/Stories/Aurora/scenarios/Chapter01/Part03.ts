...
scenarioManager.addScenario({ storyName: EStoriesEn.Aurora, chapterName: 'Глава 1', partName: 'Часть 3', code: '0' }, [
...

  {
    ...
    text:
      `
        Она была очень красива, даже несмотря на легкую злость, которую она испытывала. Белая кофта. Рыжие волосы и горящие глаза. Именно такой я запомнила ее в нашу первую встречу. 
      `,
    buttons: [
      {
        text: '',
