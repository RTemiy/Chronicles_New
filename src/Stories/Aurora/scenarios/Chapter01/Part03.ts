...
scenarioManager.addScenario({ storyName: EStoriesEn.Aurora, chapterName: 'Глава 1', partName: 'Часть 3', code: '0' }, [
  {
    ...
    ambient: require('../../../../Media/Audio/Aurora/Wind.mp3'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Observation_Dawn.jpg')
  },

  {
    ...
    text:
      `
        Небо переливалось самыми разнообразными красками, словно некий безумный художник выплеснул на полотно все яркие цвета, надеясь в этом хаосе почерпнуть вдохновение.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Я завороженно наблюдала за чудесами природы и была абсолютно уверена, что совсем скоро продолжу писать в уже полюбившийся мне дневник.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bookshelves.jpg')
  },
...

  {
    ...
    imageFront: () => { return wardrobe.getCurrentEntityImage(EStoriesEn.Aurora, 'Aurora_City') },
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bookshelves.jpg')
  },
...

  {
    ...
    text:
      `
        Она была очень красива, даже несмотря на легкую злость, которую испытывала. Белая кофта. Светлые волосы и горящие глаза. Именно такой я увидела ее в нашу первую встречу. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Оставшись наедине с собой, я выдохнула, ощутив комфортную и привычную обстановку.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Убрав книги, которыми пользовалась, чтобы повторить материал для предстоящего экзамена, я направилась в холл университета.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/University_Hall.jpg')
  },

  {
    ...
    simple: require('../../../../Media/Audio/Immortals/Beep_Long.mp3'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/University_Hall.jpg')
  },
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/University_Outside.jpg')
  },
...

  {
    ...
    text:
      `
        Не хотелось больше подслушивать чужие разговоры. К тому же, меня больше волновало то, что я нигде не видела Артура.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Я корила себя за беспечность. Ведь даже не запомнила адрес дома в котором остановилась.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bustop.jpg')
  },
...

  {
    ...
    text:
      `
        — Все хорошо — раскрасневшись произнесла я. — Мне правда с вами хорошо. Практически забыла, что оказалась в такой неловкой ситуации. А слушая вас, на душе становится гораздо теплее.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bus_Inside.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Lennart_Picture.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Bus_Inside.jpg')
  },
...

  {
    ...
    parallax: 'left',
    music: require('../../../../Media/Audio/Aurora/City.mp3'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/City_Fountain.jpg')
  },
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/City_Streets.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Cotton_Candy.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/City_Streets.jpg')
  },
...

  {
    ...
    music: require('../../../../Media/Audio/Aurora/Church.mp3'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Church.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Persons/Teenager.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    darkSilhouette: true,
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Church.jpg')
  },
...

  {
    ...
    parallax: 'right',
    imageFront: require('../../../../Media/Images/Aurora/Items/Mother_Photo.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/City_Fountain.jpg')
  },
...

  {
    ...
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Farm_Company.jpg')
  },
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Persons/Arthur_Form.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Farm_Company.jpg')
  },
...

  {
    ...
    text:
      `
        Еще больше меня волновало то, что сейчас в руках я сжимала письмо от отца. Его аккуратный почерк радовал глаз.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Ей отчего-то очень нравилось коллекционировать необычную бумагу и иногда писать особенные письма.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Father_Letter_Good.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Lighthouse.jpg')
  },
...

  {
    ...
    text:
      `
        <i> Не знаю пригодится ли навык, но это был поучительный опыт.
      `,
    buttons: [
      {
        text: '',
...
/*    music: musicPlayer[`AuroraDaily${loadData(['Aurora', 'Daily', 'Music'])}`],*/
...

  {
    ...
    imageFront: require('../../../../Media/Images/Aurora/Objects/Father_Letter_Bad.png'),
    imageBorder: require('../../../../Media/Images/Aurora/UI/Border.png'),
    imageBack: require('../../../../Media/Images/Aurora/Backgrounds/Lighthouse.jpg')
  },
