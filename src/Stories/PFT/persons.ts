...
statsManager.add({
  ...
  description: 'Вернулся в Литл-Рок после стажировки в Европе по экспериментальной психиатрии. До этого проходил клинический этап обучения в «Психиатрической клинике Святого Вита».',
  idDescription: '-'
})
