...
scenarioManager.addScenario({ storyName: EStoriesEn.PFT, chapterName: 'Глава 1', partName: 'Пролог', code: '0' }, [
...

  {
    ...
    text:
      `
         — Конечно, не передумала! Такой шанс! Сложнее всего было решиться… Не знаю, в какой раз благодарю, но правда спасибо. Ты открыла мне глаза. Дальше всё стало бы только хуже.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Какао как назло закончилось! Надеюсь, я в последний раз буду его пить».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Присцилла ехала издалека. Буду грубиянкой, если проигнорирую её».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Ну, не могу я врать в глаза! Слишком помпезно: золото, блеск... Хоть колонн нет и том спасибо».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    speakerR: 'Шэрон',
    simple: require('../../../../Media/Audio/PFT/Keys_Sheron.mp3'),
    fullscreenObjectR: require('../../../../Media/Images/PFT/Persons/Sharon.png'),
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Chamber.jpg')
  },
