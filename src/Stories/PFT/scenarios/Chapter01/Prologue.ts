...
scenarioManager.addScenario({ storyName: EStoriesEn.PFT, chapterName: 'Глава 1', partName: 'Пролог', code: '0' }, [
...

  {
    ...
    text:
      `
        Без мужа Венди уже давно нигде не появлялась. Его попытки контролировать все её выходы на улицу лишили радости от посещения любого места в городе.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Венди блуждала по лабиринтам галереи и наслаждалась. Не сказать, что девушка многое знала о живописи, но рядом с полотнами Ван Гога ощущала забытое умиротворение.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    OKMessage: { goTo: 8, image: require('../../../../Media/Images/PFT/Objects/Installation_Photo.png'), buttonText: 'Посмотреть' },
    parallax: 'left',
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Gallery.jpg')
  },

  {
    ...
    parallax: 'left',
    achievement: { story: EStoriesEn.PFT, name: 'GreenPlanet' },
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Gallery.jpg')
  },
...

  {
    ...
    text:
      `
        Среди нарисованных на голубой стене птиц, свободных и прекрасных, парили такие же белые, но неуместные в небе в отличии от божьих созданий, пластиковые пакеты.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    OKMessage: { goTo: 208, image: require('../../../../Media/Images/PFT/Objects/Artist_Portray.png'), buttonText: 'Посмотреть' },
    parallax: 'left',
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Gallery.jpg')
  },

  {
    ...
    imageBorder: require('../../../../Media/Images/PFT/UI/Border.png'),
    parallax: 'left',
    achievement: { story: EStoriesEn.PFT, name: 'Feministic' },
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Gallery.jpg')
  },
...

  {
    ...
    OKMessage: { goTo: 15, image: require('../../../../Media/Images/PFT/Objects/Vocalist_Photo.png'), buttonText: 'Посмотреть' },
    parallax: 'left',
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Gallery.jpg')
  },

  {
    ...
    imageBorder: require('../../../../Media/Images/PFT/UI/Border.png'),
    achievement: { story: EStoriesEn.PFT, name: 'GoodMusicFan' },
    parallax: 'left',
...

  {
    ...
    text:
      `
        Подпись мелким шрифтом возле полотна гласила: «Гипнос в окружении даров». На холсте был изображен молодой человек, очаровательный, каким и должен быть древнегреческий Бог.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Девушку словно молния ударила, когда глаза молодого человека на миг обратились к ней. Теперь его взгляд не был равнодушным. Гримаса боли исказила манящие черты.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         Присцилла казалась девушкой-праздником всем тем, с кем соприкасалась. Она никогда не унывала: ни после неудачных экзаменов, ни после любовных фиаско.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Лишь Венди знала её тёмную сторону. Присцилла могла быть желчной и меланхоличной. Сказывалось непростое детство. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         — Присцилла, брось! Мне бы только себя обеспечить. Никаких грандиозных планов нет.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         — Конечно, не передумала! Такой шанс! Сложнее всего было решиться… Не знаю, в какой раз благодарю, но правда спасибо. Дальше всё стало бы только хуже.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         Чтобы Венди смогла отпустить захлестнувшую печаль и страх перед неопределённостью будущего, потребовался вынужденно долгий выдох.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         Деликатное молчание по ту сторону телефона для посторонних не значило ничего. Но подругам говорило о переменах: Присцилла наконец стала проявлять свою мягкую сторону.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         Венди же приняла боль своего положения.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Не удержавшись от искушения, девушка выдернула из блокнота лист и, размашистым почерком нацарапав на нём лаконичную фразу, присмотрела место на холодильнике.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    OKMessage: { goTo: 416, buttonText: 'Прикрепить', image: require('../../../../Media/Images/PFT/Objects/Note.png') },
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Viktor_Room.jpg')
  },

  {
    ...
    text:
      `
        Блуждающий по кухне взгляд зацепился за ненавистный чай, который пришлось налить, чтобы не есть всухомятку.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Сок как назло закончился! Надеюсь, в последний раз буду пить эту горечь».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Виктор обожал Эрл Грей и каждое утро требовал, чтобы именно он ожидал на столе. Терпкий чай с сильным ароматом едва-едва перебивала сладость булочки, которую Венди купила по пути домой.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Каверзные вопросы наконец обратили на себя внимание. Венди старалась не думать о плохом, ведь муж такой внимательный и заботливый, и все ограничения были для её же блага. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Странное видение позволило Венди подняться над землёй и рассмотреть город, обрамлённый лесами. Парить в небе было совсем не страшно, словно во сне.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    simple: require('../../../../Media/Audio/PFT/WingsSlap.mp3'),
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Sky_Clouds.jpg')
  },
...

  {
    ...
    text:
      `
        Инстинктивно обернувшись прямо в воздухе вслед испарившемуся крылатому могучему созданию, Венди увидела высокую башню, которая неожиданно выбивалась из общего малоэтажного пейзажа средневекового городка.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Другие чувства постепенно вернулись. Боль, обида. Виктор сказал, что после «инцидента» она будто оцепенела и ни на что не реагировала около четверти часа.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Тягостные воспоминания вытеснила тревога, иголкой впившаяся под кожу, когда девушка уже расправилась с выпечкой. Рядом с чайником Венди заметила педантично сложенную бумажку.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    OKMessage: { goTo: 105, buttonText: 'Прочитать', image: require('../../../../Media/Images/PFT/Items/Letter.png') },
    ambient: require('../../../../Media/Audio/PFT/Ambients/Breath.mp3'),
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Viktor_Room.jpg')
  },
...

  {
    ...
    text:
      `
        Следующие строчки на пару минут расплылись перед глазами из-за нахлынувшей паники. Эта записка...
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Неужели он настолько жесток… Одно дело, когда это <i>между нами</i>, но Присцилла ни в чём не виновата!»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Внутренние демоны нашептывали всё более изощрённые варианты развития событий. Сомнения и страхи снова подняли головы, чтобы терзать Венди.
      `,
    buttons: [
      {
        text: '',
    ...
    simple: require('../../../../Media/Audio/PFT/Sounds/Doorbell.mp3'),
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Viktor_Room.jpg')
  },

  {
    ...
    text:
      `
        «Могу ли я хоть что-то решать в своей жизни или так и буду плясать под чужую дудку?!»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Не чувствую необходимости. Надо же, казалось, мы были так близки раньше... И всё равно. Так будет лучше для всех».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
       Недоумение в ответ на холодный приём застало Присциллу врасплох, но быстро сменилось едва заметной хмурой морщинкой между бровей.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
       «Вот и открывайся людям… Интересно, что с ней произошло после моего звонка».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Что я делаю с её чувствами?! Лицемерка!»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Не подозревающая о том, какая непогода бушует в сердце подруги, Присцилла расслабилась в тёплых объятиях.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Приятно всё-таки открыться кому-то, чёрт возьми!»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        В тишине девушки прошли в гостиную. Неловкость приветствия сменилась попыткой отвлечься на светскую беседу.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        На лице Присциллы было легко распознать презрение, смешанное с дежурной вежливостью.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Ну, не могу я врать в глаза! Слишком помпезно: золото, блеск... Хоть колонн нет и на том спасибо».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Как она только держится? Всё ведь и без слов понятно! А мне интерьер нравится, хоть я тут почти ничего не выбирала... Лучше бы сказала как есть!»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Стараясь скрыть за бесстрастным выражением лица смятение, Венди не замечала как нервно постукивает пальцами одной руки по предплечью другой.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Если бы Присцилла только коснулась её холодной кожи, то поняла бы, что кровь отхлынула, оставив после себя не разгорячённую злобой девушку, а голый страх.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
         — Венди, ты переводишь с японского! У меня на работе не кретины, чтобы разбрасываться такими кадрами. Ты способная и успешно доучилась в отличие от меня. Ты чего-то боишься? Что происходит?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Да, в её жизни был сложный период. Побег от самой себя и проблем стал не лучшим решением. Но теперь Присцилла осела в Финиксе и никуда не собиралась уезжать. Жизнь вошла в мирное русло.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Что ты такое говоришь?! Виктор давит на тебя… Это всё из-за него? Что он сделал?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
       «Просто уйди и хлопни дверью! Что ещё мне для этого надо сделать?!»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
       Венди на миг перестала дышать от резкости, застрявших на языке слов. Злоба на себя и на уязвимую в своих чувствах подругу захватила её. А ещё подступила к самому сердцу ядовитая ненависть к Виктору.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Темнеющее небо за окном предвещало грозу. Венди почувствовала недомогание. Весь этот разговор вызывал у неё мерзкий вкус во рту. Или не в перепалке дело?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Плечи Присциллы сами собой опустились. Она почувствовала себя грязной, завистливой, мерзкой.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «С чего я взяла, что ей нужна помощь? Что я вообще могу кому-то помочь? Наделала столько ошибок…»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        В глазах будто бы стало меньше света и Венди присела на диван. Последние капли самообладания и горечь обиды заставили Присциллу задать вопрос:
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Венди знала подругу — в пылу эмоций та не видела перед собой ничего. Девушку в очередной раз кольнула совесть за то, как она обошлась с единственным человеком, который был ей близок после смерти родителей. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    condition: [
      ...
      {
        condition: () => {
          return statsManager.get({ story: EStoriesEn.PFT, category: 'Choice', id: 'HugBack' }) <= 0 && statsManager.get({ story: EStoriesEn.PFT, category: 'Choice', id: 'SayNo' }) >= 1
        },
        goTo: 700
      },
      {
        condition: () => {
          return statsManager.get({ story: EStoriesEn.PFT, category: 'Choice', id: 'HugBack' }) >= 1 && statsManager.get({ story: EStoriesEn.PFT, category: 'Choice', id: 'SayYes' }) >= 1
        },
        goTo: 701
      }
    ],
...

  {
    ...
    text:
      `
       «Отношения не так просты, как хотелось бы».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
       «Не знаю, хочу ли сохранить наши узы».
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    speakerL: 'Венди',
    message: 'Вы не настроены на сохранение старых связей.',
    fullscreenObjectL: require('../../../../Media/Images/PFT/Persons/Wendy.png'),
    imageBack: require('../../../../Media/Images/PFT/Backgrounds/Viktor_Corridor.jpg')
  },

  {
    ...
    text:
      `
       «Присцилла добра ко мне, ничего не требуя взамен. Много ли таких людей в моей жизни?»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Придя в сознание, девушка обнаружила себя, лежащей на узкой кровати. Свежее постельное бельё было идеально белым, но жёстким к лицу. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Хотелось провалиться в фантазии, чтобы стало легче, но вдруг в палате раздался знакомый голос.
      `,
    buttons: [
      {
        text: '',
