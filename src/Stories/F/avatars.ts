...
profileManager.addAvatars([
  ...
  {
    id: 'F_OldLady',
    image: require('../../Media/Images/F/Persons/Witch_Avatar.png'),
    condition: () => achievementsManager.isUnlocked(EStoriesEn.F, 'GoDarkDeep')
  },
  {
    id: 'F_Konstantin_Office',
    image: require('../../Media/Images/F/Persons/Konstantin_Office_Avatar.png'),
  ...
  {
    id: 'F_Alice_Skirt',
    image: require('../../Media/Images/F/Persons/Alice_Skirt_Avatar.png'),
    condition: () => achievementsManager.isUnlocked(EStoriesEn.F, 'PrologueCompleted')
  },
  {
    id: 'F_Irina_Brandnew',
    image: require('../../Media/Images/F/Persons/Irina_Brandnew_Avatar.png'),
    condition: () => achievementsManager.isUnlocked(EStoriesEn.F, 'PrologueCompleted')
  }
])
