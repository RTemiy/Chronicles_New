...
scenarioManager.addScenario({ storyName: EStoriesEn.FOF, chapterName: 'Глава 1', partName: 'Часть 4', code: '0' }, [
...

  {
    ...
    text:
      `
        Парень обвел взглядом надоевшие ему стены, и, остановившись на мне, продолжил вглядываться в лицо.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        «Меня пугает то, как он смотрит. Есть в нем что-то пугающее, но в то же время, он не может не очаровать».
      `,
    buttons: [
      {
        text: '',
