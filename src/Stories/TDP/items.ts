...
statsManager.add({
  ...
  id: 'Bag',
  name: 'Рюкзак',
  image: require('../../Images/TDP/Items/Bag.png'),
...
statsManager.add({
  ...
  id: 'Dagger',
  name: 'Кинжал',
  image: require('../../Images/TDP/Items/Dagger.png'),
...
statsManager.add({
  ...
  id: 'Sugar',
  name: 'Сахар',
  image: require('../../Images/TDP/Items/Sugar.png'),
...
statsManager.add({
  ...
  id: 'Money',
  name: 'Деньги',
  image: require('../../Images/TDP/Items/Money.png'),
