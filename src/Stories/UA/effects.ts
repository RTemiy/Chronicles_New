...
statsManager.add({
  ...
  id: 'Health',
  name: 'Здоровье',
  image: require('../../Media/Images/UA/Effects/Health.svg'),
...
statsManager.add({
  ...
  id: 'Killer',
  name: 'Киллер',
  image: require('../../Media/Images/UA/Effects/Killer.svg'),
...
statsManager.add({
  ...
  id: 'Butcher',
  name: 'Мясник',
  image: require('../../Media/Images/UA/Effects/Butcher.svg'),
...
statsManager.add({
  ...
  id: 'Humanity',
  name: 'Человечность',
  image: require('../../Media/Images/UA/Effects/Humanity.svg'),
