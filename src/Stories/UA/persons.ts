...
statsManager.add({
  ...
  id: 'Eve',
  name: 'EVE-13C',
  image: require('../../Media/Images/UA/Persons/Eve.png'),
  title: 'Быть жертвой лабораторного эксперимента не страшно. Страшно быть ненужным и потерянным.',
  description: 'Если Солдат не готов к трудностям, то это плохой Солдат. Но учителя на уроках безопасности и права забыли упомянуть, что делать, если дом Отреченных падет.',
  showValue: true,
  story: EStoriesEn.UA
})
...
statsManager.add({
  ...
  id: 'Yuko',
  name: 'Юко Ямамото',
  image: require('../../Media/Images/UA/Persons/Yuko.png'),
...
statsManager.add({
  ...
  id: 'Lagard',
  name: 'Доктор Лагард',
  image: require('../../Media/Images/UA/Persons/Lagard.png'),
...
statsManager.add({
  ...
  id: 'Cerberus',
  name: 'Кей',
  image: require('../../Media/Images/UA/Persons/Cerberus.png'),
