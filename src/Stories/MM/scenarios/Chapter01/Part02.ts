...
scenarioManager.addScenario({ storyName: EStoriesEn.MM, chapterName: 'Глава 1', partName: 'Часть 2', code: '0' }, [
...

  {
    ...
    text:
      `
        Маргарита вот уже несколько минут смотрела куда-то мимо Джонатана. В воздухе буквально ощущалась неправильность ситуации. Повисло нестерпимо <i>долгое молчание, по-своему угнетающее.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        ! Реклама<p>Хлопнула дверь комнаты, но Дилан не заметил, как детектив покинула место. Он устало протер глаза, подошел к мониторам, ставя на паузу записывающиеся видео и аудиоустройства, и вошел в допросную.
      `,
    buttons: [
      {
        text: 'Продолжить',
...

  {
    ...
    text:
      `
        — Мы об <i>этом не договаривались. Зачем ты вообще сказал ей, что знаешь про эти улики?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Папка с глухим звуком упала на стол, включились видео и аудиозаписи. И все вроде бы встало на свои места, но только не чувства Дилана, впрочем, они и не смогут прийти в норму. <i>Такое никогда не станет нормой, не для него.
      `,
    buttons: [
      {
        text: '',
