...
statsManager.add({
  ...
  id: 'BurntMessage',
  name: 'Записка',
  image: require('../../Media/Images/MM/Objects/Burnt_Letter.png'),
...
statsManager.add({
  ...
  id: 'Earring',
  name: 'Серьга',
  image: require('../../Media/Images/MM/Objects/Silver_Earring.png'),
...
statsManager.add({
  ...
  id: 'Jonathan_Report',
  name: 'Отчет',
  image: require('../../Media/Images/MM/Items/Jonathan_Report.jpg'),
...
statsManager.add({
  ...
  id: 'Fingerprinting',
  name: 'Дактилоскопия',
  image: require('../../Media/Images/MM/Items/Fingerprinting.jpg'),
