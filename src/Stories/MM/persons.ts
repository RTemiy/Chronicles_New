...
statsManager.add({
  ...
  id: 'Dylan',
  name: 'Дилан',
  image: require('../../Media/Images/MM/Persons/Dylan.png'),
...
statsManager.add({
  ...
  id: 'Arthur',
  name: 'Артур',
  image: require('../../Media/Images/MM/Persons/Arthur.png'),
...
statsManager.add({
  ...
  id: 'Mike',
  name: 'Майк',
  image: require('../../Media/Images/MM/Persons/Mike.png'),
...
statsManager.add({
  ...
  id: 'Jonathan',
  name: 'Джонатан',
  image: require('../../Media/Images/MM/Persons/Jonathan.png'),
