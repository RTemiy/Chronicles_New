...
scenarioManager.addScenario({ storyName: EStoriesEn.Immortals, chapterName: 'Глава 1', partName: 'Часть 4', code: '0' }, [
...

  {
    ...
    text:
      `
        Солнце слепило, а свежий воздух дурманил разум.<p> <p>Нас уже ожидал небольшой экипаж и не слишком терпеливый кучер. Когда мы сели внутрь, я по-настоящему расслабилась, радуясь, что мне удалось сменить обстановку.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Наверняка твоя работа связана с криминалом. И чтобы не вызывать лишних подозрений у посторонних, ты играешь роль примерного мужа, так?<p> <p>— Не совсем, — Роберта, казалось, позабавил мой вывод. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Наверняка ты какой-нибудь детектив, выслеживающий всяких мафиози. И чтобы не вызывать лишних подозрений у посторонних, ты играешь роль примерного мужа, так?<p> <p>— Не совсем, — Роберта, казалось, позабавил мой вывод. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Спасибо, это действительно то, что мне нужно.<p> <p>Ничего подобного до этого я не пила. Напиток на вкус был обжигающим, с нотками карамели и каких-то трав.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Нет, спасибо, не думаю, что мне сейчас это нужно.<p> <p>— Как знаешь, а вот я выпью, — сказал Роберт и сделал приличный глоток напитка.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        После затяжной паузы я все же решила уточнить:<p> <p>— Так что, Роберт? Что все это значит?
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Кстати, — он остановился перед выходом. — Я нашел это на полу рядом с тобой, может, он твой, не знаю. Решай сама.<p> <p>Мужчина протянул мне тот самый нож, который служил защитой от монстра.<p> «Эта вещь напоминание о произошедшем. Стоит ли его сохранить?»
      `,
    buttons: [
      {
        text: 'Оставить нож',
...

  {
    ...
    text:
      `
        — Я должен пообщаться с гостями в более приватной обстановке. Посиди еще тут, выпей шампанского. В конце концов пообщайся с другими женщинами.<p> <p>От чего-то меня захлестнула обида. Почему он постоянно уходит, когда ему вздумается, совершенно игнорируя мое состояние? 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Ты удивительная девушка, я горд и безмерно счастлив, что имею честь быть знакомым с тобой.<p> <p>Никола радушно улыбнулся и развел руки в стороны, приглашая меня в свои объятия. Я прильнула к его груди и почувствовала размеренное дыхание.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Мне было сложно мириться с его характером. К сожалению, этот человек был себе на уме и я не могла даже подобрать какой-нибудь фразы, чтобы продолжить диалог.<p> <p>Далее
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Мне ничего не оставалось, кроме как бежать обратно в зал, но похититель был проворнее.<p> «А если ему нужна помощь? Я не могу его здесь просто бросить.»
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Мне удалось найти в себе силы и отвернуться. Мое тело ныло от желания, но разум оставался чистым и непреклонным.<p> <p>— Почему ты такая упрямая? — мужчина заметно погрустнел. — Это же всего лишь небольшая шалость. Давай же, я сделаю тебе очень хорошо! 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    condition: [
      ...
      {
        condition: () => {
          return statsManager.get({ story: EStoriesEn.Immortals, category: 'Effect', id: 'BrokenHand' }) <= 4
        },
        goTo: 406
      }
    ],
