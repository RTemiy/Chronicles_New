...
scenarioManager.addScenario({ storyName: EStoriesEn.Immortals, chapterName: 'Глава 1', partName: 'Часть 4', code: '1' }, [
...

  {
    ...
    text:
      `
        — Прошу выйти на сцену мистера Николу Тесла с его покровителем — Робертом Джонсоном!
      `,
    buttons: [
      {
        text: '',
  ...
  },
  {
    ...
    text:
      `
        Так прошло несколько дней моего пребывания в больнице. Меня не покидала надежда о скором возвращении свой мир, однако я все еще была непрошенным гостем эпохи Теслы.
      `,
    buttons: [
      {
        text: '',
    ...
    text:
      `
       — Я надеюсь, что тебе, как и мне однажды, Бог покажет нужные знаки. Но не забывай, что нас лишь направляют, все остальное зависит от тебя.
      `,
    buttons: [
      {
        text: '',
    ...
    text:
      `
        Вскоре экипаж остановился. Я самостоятельно попыталась встать, но Роберт остановил меня. Он подал мне руку и помог выбраться из транспорта.
      `,
    buttons: [
      {
        text: '',
  ...
  },
  {
    ...
    text:
      `
     Роберт перевел взгляд на часы, встал и стал собирать некоторые вещи. 
      `,
    buttons: [
      {
        text: '',
