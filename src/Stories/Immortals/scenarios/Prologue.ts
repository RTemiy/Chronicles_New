...
import { slideMessage } from '../../../Components/Slide/Slide'
...
`,
    buttons: [{ text: '', func: () => { scenarioManager.beginScene(4) } }],
    imageBack: require('../../../Images/Immortals/Backgrounds/Guides_World.png'),
...
`,
    buttons: [{ text: '', func: () => { askForInput('Как меня зовут?', (value) => { slideMessage(value); scenarioManager.beginScene(0) }) } }],
    imageBack: require('../../../Images/Immortals/Backgrounds/Guides_World.png'),
    imageFront: require('../../../Images/Immortals/Persons/Hero.png'),
    imageBorder: require('../../../Images/UI/bottom_border.png')
  }
