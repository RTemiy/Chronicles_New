...
scenarioManager.addScenario(EStoriesEn.Immortals, 'Глава 1', 'Пролог', '0', [
...

  {
    ...
    text:
			`
        Я медленно открыла глаза. Первое время мозг не мог воспринять место, в котором я очутилась. Странные свечения, пустота… Вокруг неестественно парили камни, не поддаваясь никаким законам физики.<p>“Это не может быть реальностью!”
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
			`
        Я попыталась вспомнить хоть какие-то фрагменты из своей жизни, но пришла в ужас от осознания полного забвения. В голову приходили только самые банальные вопросы. <p>Робко взглянув на него, тихий голос спросил.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Прекрати! — я сорвалась на крик. — Это все не может быть правдой. Свою жизнь я не помню.<p>— Это пока…
      `,
    buttons: [
      {
        text: ''
...

  {
    ...
    text:
      `
        — Ты всегда будешь говорить загадками? — я обреченно вздохнула.<p>— Нет, только когда это уместно.
      `,
    buttons: [
      {
        text: ''
...

  {
    ...
    text:
      `
        Проводник разразился смехом.<p>— Бинго! Я всегда жду, когда зададут этот вопрос. <p>— Но ты не ответил… А я и не знаю, что думать. Ты выглядишь как жнец, готовящийся отправить меня в преисподнюю.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        — Здесь нам ничто не может угрожать. Быть может только бренное существование… Одинокое… — с грустью в голосе сказал неизвестный. — Но не стоит об этом.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Мои забытые ощущения брали вверх. Тело стало еще сильнее дрожать, и я начала осознавать, как начинаю теряться в этом темном и мрачном хаосе.<p>— Я не могу…  Я не понимаю.
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
      `
        Проводник, до этого стоявший на одном месте, подошел ко мне и положил ладонь мне на плечо.<p>Постепенно дрожь прошла, а чувства возвращались в норму. 
      `,
    buttons: [
      {
        text: '',
...

  {
    ...
    text:
			`
        — Ты готова?<p>Я неуверенно кивнула, следуя за таинственным гостем в неизвестность.
      `,
    buttons: [
      {
        func: () => {
