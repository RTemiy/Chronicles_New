...
statsManager.add({
  ...
  id: 'Knife',
  name: 'Нож',
  image: require('../../Media/Images/ROR/Items/Knife.png'),
...
statsManager.add({
  ...
  id: 'Sugar',
  name: 'Сахар',
  image: require('../../Media/Images/ROR/Items/Sugar.png'),
...
statsManager.add({
  ...
  id: 'Letter01',
  name: 'Письмо',
  image: require('../../Media/Images/ROR/Items/Envelope.png'),
...
statsManager.add({
  ...
  id: 'Antihangover',
  name: 'Зелье',
  image: require('../../Media/Images/ROR/Objects/Antihangover.png'),
